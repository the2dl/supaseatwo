...
SUPABASE_URL = os.getenv('SUPABASE_URL', "https://blahgoecw.supabase.co")
SUPABASE_KEY = os.getenv('SUPABASE_KEY', "your_supa_key")
OPENAI_API_KEY = os.getenv('OPENAI_API_KEY', "your_oia_key")
